...
public class EJBClientUtilities {
     ...
     */
    private static final String EAR_APPLICATION_NAME = "BundlerCleanup";
    
    /**
     * The name of the module (i.e. JAR) containing the EJBs
     */
    private static final String EJB_MODULE_NAME = "BundlerCleanupEJB";
    ...
    /**
     * Utility method used to look up the CleanupTimerBean interface.  
     * This method is only called by the web tier.
     * 
     * @return The CleanupTimerBean interface, or null if we couldn't 
     * look it up.
     */
    public DiskCleanupService getCleanupService() {
